    ...
    value: function test() {
      ...
      this.buttons.forEach(function (btn) {
        btn.addEventListener('click', function () {
          _this.modal.forEach(function (modal) {
            if (modal.dataset.type === btn.dataset.type) {
              console.log(modal);
            }
          });
        });
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.querySelector('.mobile_menu')) {
    ...
    var mobileMenu = document.querySelector('.mobile_menu-form');
...
} // if (document.querySelector('.carriers-slider')){
//     let cartSlider = document.querySelector('.carriers-slider')
//
//     let carriersSwiper = new Swiper('.carriers-slider', {
//         slidesPerView: 1,
//         spaceBetween: 40,
//         slidesPerGroup: 1,
//         loop: true,
...
//         speed: 300,
//         navigation: {
//             nextEl: '.carriers-slider__next',
//             prevEl: '.carriers-slider__prev',
//         },
//         breakpoints: {
//             640: {
//                 slidesPerView: 1,
...
//     });
//
//     carriersSlider.addEventListener('mouseover', () => {
//         carriersSwiper.autoplay.stop()
//     });
//     carriersSlider.addEventListener('mouseout', () => {
//         carriersSwiper.autoplay.start()
//     });
// }